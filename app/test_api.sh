...
print_step "2. Get All Servers (Initial State)"
initial_servers=$(api_call "GET" "$API_V1/servers" "" "Retrieving all servers...")

# Create first server
print_step "3. Create Server #1"
server1_data='{
    "name": "web-server-01",
    "os": "Ubuntu",
...
print_step "9. Partial Update Server"
partial_update_data='{
...
# Get final state
print_step "12. Final State - Get All Servers"
